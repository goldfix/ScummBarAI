...
> Source: [https://www.python-httpx.org/third_party_packages/](https://www.python-httpx.org/third_party_packages/)

[ Skip to content ](<https://www.python-httpx.org/third_party_packages/#third-party-packages>)
...
Provides authentication classes to be used with HTTPX's [authentication parameter](<https://www.python-httpx.org/advanced/authentication/#customizing-authentication>).
...
This public gist provides an example implementation for a [custom transport](<https://www.python-httpx.org/advanced/transports/#custom-transports>) implementation on top of the battle-tested [`urllib3`](<https://urllib3.readthedocs.io>) library.