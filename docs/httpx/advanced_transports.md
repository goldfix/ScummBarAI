...
> Source: [https://www.python-httpx.org/advanced/transports/](https://www.python-httpx.org/advanced/transports/)

[ Skip to content ](<https://www.python-httpx.org/advanced/transports/#http-transport>)
...
For more advanced use-cases you might want to take a look at either [the third-party mocking library, RESPX](<https://lundberg.github.io/respx/>), or the [pytest-httpx library](<https://github.com/Colin-b/pytest_httpx>).

## Mounting transports

You can also mount transports against given schemes or domains, to control which transport an outgoing request should be routed via, with [the same style used for specifying proxy routing](<https://www.python-httpx.org/advanced/transports/#routing>).
...
See documentation on [`HTTP_PROXY`, `HTTPS_PROXY`, `ALL_PROXY`](<https://www.python-httpx.org/environment_variables/#http_proxy-https_proxy-all_proxy>) and [`NO_PROXY`](<https://www.python-httpx.org/environment_variables/#no_proxy>) for more information.