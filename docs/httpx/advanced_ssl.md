...
> Source: [https://www.python-httpx.org/advanced/ssl/](https://www.python-httpx.org/advanced/ssl/)

[ Skip to content ](<https://www.python-httpx.org/advanced/ssl/#enabling-and-disabling-verification>)
...
`httpx` does respect the `SSL_CERT_FILE` and `SSL_CERT_DIR` environment variables by default. For details, refer to [the section on the environment variables page](<https://www.python-httpx.org/environment_variables/#ssl_cert_file>).
