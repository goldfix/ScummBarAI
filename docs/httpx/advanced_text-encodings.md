# Text Encodings - HTTPX

> Source: [https://www.python-httpx.org/advanced/text-encodings/](https://www.python-httpx.org/advanced/text-encodings/)

[ Skip to content ](<https://www.python-httpx.org/advanced/text-encodings/#using-the-default-encoding>)
