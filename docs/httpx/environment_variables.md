# Environment Variables - HTTPX

> Source: [https://www.python-httpx.org/environment_variables/](https://www.python-httpx.org/environment_variables/)

[ Skip to content ](<https://www.python-httpx.org/environment_variables/#environment-variables>)
...
For more information on using proxies in HTTPX, see [HTTP Proxying](<https://www.python-httpx.org/advanced/proxies/#http-proxying>).
