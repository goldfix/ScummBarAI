...
number of tokens in _the input only_. Make this call before sending input
...
[Python](https://ai.google.dev/gemini-api/docs/tokens#python)[JavaScript](https://ai.google.dev/gemini-api/docs/tokens#javascript)[REST](https://ai.google.dev/gemini-api/docs/tokens#rest)More
...
[Python](https://ai.google.dev/gemini-api/docs/tokens#python)[JavaScript](https://ai.google.dev/gemini-api/docs/tokens#javascript)More
...
[Python](https://ai.google.dev/gemini-api/docs/tokens#python)More
