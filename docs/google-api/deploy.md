# Deploying Your Agent - Agent Development Kit (ADK)

> Source: [https://adk.dev/deploy/](https://adk.dev/deploy/)

[ Skip to content ](<https://adk.dev/deploy/#deploying-your-agent>)

[ ](<https://github.com/google/adk-docs/edit/main/docs/deploy/index.md> "Edit this page on GitHub") [ ](<https://adk.dev/deploy/index.md> "View this page as Markdown")

# Deploying Your Agent[¶](<https://adk.dev/deploy/#deploying-your-agent> "Permanent link")
...
![Deploying your agent](https://adk.dev/assets/deploy-agent.png)

## Deployment Options[¶](<https://adk.dev/deploy/#deployment-options> "Permanent link")
...
### Agent Runtime on Agent Platform[¶](<https://adk.dev/deploy/#agent-runtime-on-agent-platform> "Permanent link")

[Agent Runtime](<https://adk.dev/deploy/agent-runtime/>) is a fully managed auto-scaling service on Google Cloud specifically designed for deploying, managing, and scaling AI agents built with frameworks such as ADK.

Learn more about [deploying your agent to Agent Runtime](<https://adk.dev/deploy/agent-runtime/>).

### Cloud Run[¶](<https://adk.dev/deploy/#cloud-run> "Permanent link")
...
### Google Kubernetes Engine (GKE)[¶](<https://adk.dev/deploy/#google-kubernetes-engine-gke> "Permanent link")
...
### Other Container-friendly Infrastructure[¶](<https://adk.dev/deploy/#other-container-friendly-infrastructure> "Permanent link")
