# Conversational context - Agent Development Kit (ADK)

> Source: [https://adk.dev/sessions/](https://adk.dev/sessions/)

[ Skip to content ](<https://adk.dev/sessions/#conversational-context-session-state-and-memory>)

[ ](<https://github.com/google/adk-docs/edit/main/docs/sessions/index.md> "Edit this page on GitHub") [ ](<https://adk.dev/sessions/index.md> "View this page as Markdown")

# Conversational Context: Session, State, and Memory[¶](<https://adk.dev/sessions/#conversational-context-session-state-and-memory> "Permanent link")
...
## Core Concepts[¶](<https://adk.dev/sessions/#core-concepts> "Permanent link")
...
## Managing Context: Services[¶](<https://adk.dev/sessions/#managing-context-services> "Permanent link")
...
## What's Next?[¶](<https://adk.dev/sessions/#whats-next> "Permanent link")
