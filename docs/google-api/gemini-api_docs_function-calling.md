...
> Source: [https://ai.google.dev/gemini-api/docs/function-calling](https://ai.google.dev/gemini-api/docs/function-calling)
...
For Gemini 3 series models, combine function calling with [structured output](<https://ai.google.dev/gemini-api/docs/structured-output>) for consistently formatted responses.
