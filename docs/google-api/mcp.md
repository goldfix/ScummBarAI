# Model Context Protocol (MCP) - Agent Development Kit (ADK)

> Source: [https://adk.dev/mcp/](https://adk.dev/mcp/)

[ Skip to content ](<https://adk.dev/mcp/#model-context-protocol-mcp>)

[ ](<https://github.com/google/adk-docs/edit/main/docs/mcp/index.md> "Edit this page on GitHub") [ ](<https://adk.dev/mcp/index.md> "View this page as Markdown")

# Model Context Protocol (MCP)[¶](<https://adk.dev/mcp/#model-context-protocol-mcp> "Permanent link")
...
## How does MCP work?[¶](<https://adk.dev/mcp/#how-does-mcp-work> "Permanent link")

MCP follows a client-server architecture, defining how data (resources), interactive templates (prompts), and actionable functions (tools) are exposed by an MCP server and consumed by an MCP client (which could be an LLM host application or an AI agent).

## MCP Tools in ADK[¶](<https://adk.dev/mcp/#mcp-tools-in-adk> "Permanent link")
...
See [Tools and Integrations](<https://adk.dev/integrations/>) for pre-built MCP tools you can use in your agents. Refer to the [MCP Tools documentation](<https://adk.dev/tools-custom/mcp-tools/>) for code samples and design patterns that help you use ADK together with MCP servers, including:
...
## ADK Agent and FastMCP server[¶](<https://adk.dev/mcp/#adk-agent-and-fastmcp-server> "Permanent link")
...
Refer to the [MCP Tools](<https://adk.dev/tools-custom/mcp-tools/>) documentation on how you can use ADK together with the FastMCP server running on Cloud Run.

## MCP Servers for Google Cloud Genmedia[¶](<https://adk.dev/mcp/#mcp-servers-for-google-cloud-genmedia> "Permanent link")
