...
> Source: [https://ai.google.dev/gemini-api/docs/tokens](https://ai.google.dev/gemini-api/docs/tokens)
...
You can count tokens in the following ways:
  ...
  * **Call`count_tokens` with the input of the request.** Returns the total number of tokens in _the input only_. Make this call before sending input to check the size of your requests.
