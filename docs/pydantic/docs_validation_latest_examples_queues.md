# Queues | Pydantic Docs

> Source: [https://pydantic.dev/docs/validation/latest/examples/queues/](https://pydantic.dev/docs/validation/latest/examples/queues/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/examples/queues/#_top>)
