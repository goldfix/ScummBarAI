...
> Source: [https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/](https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#_top>)
...
When using [Visual Studio Code (VS Code)](<https://code.visualstudio.com/>), there are some **additional editor features** supported, comparable to the ones provided by the [PyCharm plugin](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/pycharm>).
...
This would include the errors detected by the [Pydantic mypy plugin](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/mypy>), if you configured it.
