# Databases | Pydantic Docs

> Source: [https://pydantic.dev/docs/validation/latest/examples/orms/](https://pydantic.dev/docs/validation/latest/examples/orms/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/examples/orms/#_top>)
