...
> Source: [https://pydantic.dev/docs/validation/latest/errors/usage_errors/](https://pydantic.dev/docs/validation/latest/errors/usage_errors/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/errors/usage_errors/#_top>)
