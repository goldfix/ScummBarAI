...
> Source: [https://pydantic.dev/docs/validation/latest/concepts/experimental/](https://pydantic.dev/docs/validation/latest/concepts/experimental/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/concepts/experimental/#_top>)
