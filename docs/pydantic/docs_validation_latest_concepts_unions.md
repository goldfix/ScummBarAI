# Unions | Pydantic Docs

> Source: [https://pydantic.dev/docs/validation/latest/concepts/unions/](https://pydantic.dev/docs/validation/latest/concepts/unions/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/concepts/unions/#_top>)
...
In smart mode, the following steps are taken to try to select the best match for the input:
  ...
  * [ BaseModel, dataclass, and TypedDict ](<https://pydantic.dev/docs/validation/latest/concepts/unions/#tab-panel-742>)
  * [ All other data types ](<https://pydantic.dev/docs/validation/latest/concepts/unions/#tab-panel-743>)
