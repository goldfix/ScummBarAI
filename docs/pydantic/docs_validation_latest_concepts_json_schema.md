...
> Source: [https://pydantic.dev/docs/validation/latest/concepts/json_schema/](https://pydantic.dev/docs/validation/latest/concepts/json_schema/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/concepts/json_schema/#_top>)
