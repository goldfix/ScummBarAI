# Conversion Table | Pydantic Docs

> Source: [https://pydantic.dev/docs/validation/latest/concepts/conversion_table/](https://pydantic.dev/docs/validation/latest/concepts/conversion_table/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/concepts/conversion_table/#_top>)
...
The “Strict” column contains checkmarks for type conversions that are allowed when validating in [Strict Mode](<https://pydantic.dev/docs/validation/latest/concepts/strict_mode>).
  ...
  * [ All ](<https://pydantic.dev/docs/validation/latest/concepts/conversion_table/#tab-panel-715>)
  * [ JSON ](<https://pydantic.dev/docs/validation/latest/concepts/conversion_table/#tab-panel-716>)
  * [ JSON - Strict ](<https://pydantic.dev/docs/validation/latest/concepts/conversion_table/#tab-panel-717>)
  * [ Python ](<https://pydantic.dev/docs/validation/latest/concepts/conversion_table/#tab-panel-718>)
  * [ Python - Strict ](<https://pydantic.dev/docs/validation/latest/concepts/conversion_table/#tab-panel-719>)
