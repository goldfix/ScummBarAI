# Dynamic models | Pydantic Docs

> Source: [https://pydantic.dev/docs/validation/latest/examples/dynamic_models/](https://pydantic.dev/docs/validation/latest/examples/dynamic_models/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/#_top>)
...
In this example, we will show how to dynamically derive a model from an existing one, making every field optional. To achieve this, we will make use of the [`model_fields`](<https://pydantic.dev/docs/validation/latest/api/pydantic/base_model/#pydantic.BaseModel.model_fields>) model class attribute, and derive new annotations from the field definitions to be passed to the [`create_model()`](<https://pydantic.dev/docs/validation/latest/api/pydantic/base_model/#pydantic.create_model>) factory. Of course, this example can apply to any use case where you need to derive a new model from another (remove default values, add aliases, etc).
  ...
  * [ Python 3.9 ](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/#tab-panel-758>)
  * [ Python 3.10 ](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/#tab-panel-759>)
  * [ Python 3.11 and above ](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/#tab-panel-760>)
...
With that in mind, we can recreate an annotation that “simulates” the one from the original model:
  ...
  * [ Python 3.9 and above ](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/#tab-panel-756>)
  * [ Python 3.11 and above ](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/#tab-panel-757>)
...
A couple notes on the implementation:
  ...
  * [ Python 3.9 and above ](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/#tab-panel-754>)
  * [ Python 3.12 and above ](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/#tab-panel-755>)
