# AWS Lambda | Pydantic Docs

> Source: [https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/](https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/)

[Skip to content](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#_top>)
