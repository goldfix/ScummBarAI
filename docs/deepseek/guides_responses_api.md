...
[Skip to main content](<https://api-docs.deepseek.com/guides/responses_api#__docusaurus_skipToContent_fallback>)
...
---|---  
`model`| Supported. Currently only `deepseek-v4-flash` (`deepseek-v4-pro` is not supported yet), see [Models & Pricing](<https://api-docs.deepseek.com/quick_start/pricing>)  
...
### Input Items[​](<https://api-docs.deepseek.com/guides/responses_api#input-items> "Direct link to Input Items")
...
Token usage is returned in `usage`:
  ...
  * [Compatibility Details](<https://api-docs.deepseek.com/guides/responses_api#compatibility-details>)
    ...
    * [Tools](<https://api-docs.deepseek.com/guides/responses_api#tools>)
    * [Response Fields](<https://api-docs.deepseek.com/guides/responses_api#response-fields>)
