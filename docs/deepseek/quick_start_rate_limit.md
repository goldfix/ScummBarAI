...
> Source: [https://api-docs.deepseek.com/quick_start/rate_limit](https://api-docs.deepseek.com/quick_start/rate_limit)

[Skip to main content](<https://api-docs.deepseek.com/quick_start/rate_limit#__docusaurus_skipToContent_fallback>)
...
## user_id Isolation[​](<https://api-docs.deepseek.com/quick_start/rate_limit#user_id-isolation> "Direct link to user_id Isolation")
...
### Setting user_id[​](<https://api-docs.deepseek.com/quick_start/rate_limit#setting-user_id> "Direct link to Setting user_id")
...
If the request has not started inference after 10 minutes, the server will close the connection.
  ...
  * [Concurrency Limit](<https://api-docs.deepseek.com/quick_start/rate_limit#concurrency-limit>)
  * [user_id Isolation](<https://api-docs.deepseek.com/quick_start/rate_limit#user_id-isolation>)
    * [Setting user_id](<https://api-docs.deepseek.com/quick_start/rate_limit#setting-user_id>)
  * [Request Keep-Alive Mechanism](<https://api-docs.deepseek.com/quick_start/rate_limit#request-keep-alive-mechanism>)
