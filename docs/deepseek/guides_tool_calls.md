...
[Skip to main content](<https://api-docs.deepseek.com/guides/tool_calls#__docusaurus_skipToContent_fallback>)
...
You can use `$def` to define reusable modules and then use `$ref` to reference them, reducing schema repetition and enabling modularization. Additionally, `$ref` can be used independently to define recursive structures.
  ...
  * [Non-thinking Mode](<https://api-docs.deepseek.com/guides/tool_calls#non-thinking-mode>)
    * [Sample Code](<https://api-docs.deepseek.com/guides/tool_calls#sample-code>)
  * [Thinking Mode](<https://api-docs.deepseek.com/guides/tool_calls#thinking-mode>)
  * [`strict` Mode (Beta)](<https://api-docs.deepseek.com/guides/tool_calls#strict-mode-beta>)
    * [Support Json Schema Types In `strict` Mode](<https://api-docs.deepseek.com/guides/tool_calls#support-json-schema-types-in-strict-mode>)
