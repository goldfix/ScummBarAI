...
> Source: [https://fastapi.tiangolo.com/how-to/configure-swagger-ui/](https://fastapi.tiangolo.com/how-to/configure-swagger-ui/)
...
If you need to use JavaScript-only configurations like those, you can use one of the methods above. Override the whole Swagger UI _path operation_ and manually write any JavaScript you need.
