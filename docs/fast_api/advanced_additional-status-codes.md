...
> Source: [https://fastapi.tiangolo.com/advanced/additional-status-codes/](https://fastapi.tiangolo.com/advanced/additional-status-codes/)
...
For example, let's say that you want to have a _path operation_ that allows updating items, and returns HTTP status codes of 200 "OK" when successful.
