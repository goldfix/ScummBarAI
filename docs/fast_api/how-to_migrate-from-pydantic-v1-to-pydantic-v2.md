...
> Source: [https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/](https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/)

[ Skip to content ](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#migrate-from-pydantic-v1-to-pydantic-v2>)

# Migrate from Pydantic v1 to Pydantic v2[¶](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#migrate-from-pydantic-v1-to-pydantic-v2> "Permanent link")
...
## Official Guide[¶](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#official-guide> "Permanent link")
...
## Tests[¶](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#tests> "Permanent link")
...
## `bump-pydantic`[¶](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#bump-pydantic> "Permanent link")
...
## Pydantic v1 in v2[¶](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#pydantic-v1-in-v2> "Permanent link")
...
### FastAPI support for Pydantic v1 in v2[¶](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#fastapi-support-for-pydantic-v1-in-v2> "Permanent link")
...
### Pydantic v1 parameters[¶](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#pydantic-v1-parameters> "Permanent link")
...
### Migrate in steps[¶](<https://fastapi.tiangolo.com/how-to/migrate-from-pydantic-v1-to-pydantic-v2/#migrate-in-steps> "Permanent link")
