...
> Source: [https://fastapi.tiangolo.com/advanced/advanced-python-types/](https://fastapi.tiangolo.com/advanced/advanced-python-types/)

[ Skip to content ](<https://fastapi.tiangolo.com/advanced/advanced-python-types/#advanced-python-types>)
