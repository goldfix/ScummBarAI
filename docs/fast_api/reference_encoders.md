...
> Source: [https://fastapi.tiangolo.com/reference/encoders/](https://fastapi.tiangolo.com/reference/encoders/)
...
##  `` fastapi.encoders.jsonable_encoder [¶](<https://fastapi.tiangolo.com/reference/encoders/#fastapi.encoders.jsonable_encoder> "Permanent link")
...
`custom_encoder` |  Pydantic's `custom_encoder` parameter, passed to Pydantic models to define a custom encoder. **TYPE:** `[dict](<https://fastapi.tiangolo.com/python-types/#dict> "Dict")[Any, Callable[[Any], Any]] | None` **DEFAULT:** `None`  
