...
> Source: [https://fastapi.tiangolo.com/tutorial/security/simple-oauth2/](https://fastapi.tiangolo.com/tutorial/security/simple-oauth2/)
...
For a more complete explanation of `**user_dict` check back in [the documentation for **Extra Models**](<https://fastapi.tiangolo.com/tutorial/extra-models/#about-user-in-model-dump>).
