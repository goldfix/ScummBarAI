...
> Source: [https://fastapi.tiangolo.com/async/](https://fastapi.tiangolo.com/async/)
...
So, if you are using a library that tells you that you can call it with `await`, you need to create the _path operation functions_ that use it with `async def`, like in:
