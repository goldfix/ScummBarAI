...
> Source: [https://fastapi.tiangolo.com/python-types/](https://fastapi.tiangolo.com/python-types/)
...
### `typing` module[¶](<https://fastapi.tiangolo.com/python-types/#typing-module> "Permanent link")
