...
> Source: [https://fastapi.tiangolo.com/tutorial/bigger-applications/](https://fastapi.tiangolo.com/tutorial/bigger-applications/)
...
You can do this before or after including `router` in the `FastAPI` app. FastAPI will still include the _path operations_ from `other_router` in routing and OpenAPI.

The same applies to _path operations_ added later to the routers. They will be visible through the earlier inclusion too.
