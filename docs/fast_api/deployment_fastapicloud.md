...
> Source: [https://fastapi.tiangolo.com/deployment/fastapicloud/](https://fastapi.tiangolo.com/deployment/fastapicloud/)

[ Skip to content ](<https://fastapi.tiangolo.com/deployment/fastapicloud/#fastapi-cloud>)

# FastAPI Cloud[¶](<https://fastapi.tiangolo.com/deployment/fastapicloud/#fastapi-cloud> "Permanent link")
...
## About FastAPI Cloud[¶](<https://fastapi.tiangolo.com/deployment/fastapicloud/#about-fastapi-cloud> "Permanent link")
...
## Deploy to other cloud providers[¶](<https://fastapi.tiangolo.com/deployment/fastapicloud/#deploy-to-other-cloud-providers> "Permanent link")

FastAPI is open source and based on standards. You can deploy FastAPI apps to any cloud provider you choose.

Follow your cloud provider's guides to deploy FastAPI apps with them. 🤓

## Deploy your own server[¶](<https://fastapi.tiangolo.com/deployment/fastapicloud/#deploy-your-own-server> "Permanent link")
