...
> Source: [https://fastapi.tiangolo.com/advanced/dataclasses/](https://fastapi.tiangolo.com/advanced/dataclasses/)
...
## Dataclasses in `response_model`[¶](<https://fastapi.tiangolo.com/advanced/dataclasses/#dataclasses-in-response-model> "Permanent link")
