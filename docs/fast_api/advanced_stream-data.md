...
> Source: [https://fastapi.tiangolo.com/advanced/stream-data/](https://fastapi.tiangolo.com/advanced/stream-data/)

[ Skip to content ](<https://fastapi.tiangolo.com/advanced/stream-data/#stream-data>)

# Stream Data[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#stream-data> "Permanent link")
...
## Use Cases[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#use-cases> "Permanent link")
...
## A `StreamingResponse` with `yield`[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#a-streamingresponse-with-yield> "Permanent link")
...
### Non-async _path operation functions_[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#non-async-path-operation-functions> "Permanent link")
...
### No Annotation[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#no-annotation> "Permanent link")
...
### Stream Bytes[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#stream-bytes> "Permanent link")
...
## A Custom `PNGStreamingResponse`[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#a-custom-pngstreamingresponse> "Permanent link")
...
### Simulate a File[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#simulate-a-file> "Permanent link")
...
### Files and Async[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#files-and-async> "Permanent link")
...
### `yield from`[¶](<https://fastapi.tiangolo.com/advanced/stream-data/#yield-from> "Permanent link")
