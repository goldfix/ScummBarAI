...
> Source: [https://fastapi.tiangolo.com/advanced/security/http-basic-auth/](https://fastapi.tiangolo.com/advanced/security/http-basic-auth/)
...
#### Fix it with `secrets.compare_digest()`[¶](<https://fastapi.tiangolo.com/advanced/security/http-basic-auth/#fix-it-with-secrets-compare-digest> "Permanent link")
