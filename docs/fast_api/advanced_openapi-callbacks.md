...
> Source: [https://fastapi.tiangolo.com/advanced/openapi-callbacks/](https://fastapi.tiangolo.com/advanced/openapi-callbacks/)
...
There are 2 main differences from a normal _path operation_ :
  ...
  * The _path_ can contain an [OpenAPI 3 expression](<https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.0.md#key-expression>) (see more below) where it can use variables with parameters and parts of the original request sent to _your API_.
...
The callback _path_ can have an [OpenAPI 3 expression](<https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.0.md#key-expression>) that can contain parts of the original request sent to _your API_.
