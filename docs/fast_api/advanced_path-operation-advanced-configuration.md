...
> Source: [https://fastapi.tiangolo.com/advanced/path-operation-advanced-configuration/](https://fastapi.tiangolo.com/advanced/path-operation-advanced-configuration/)
