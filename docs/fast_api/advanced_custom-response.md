...
> Source: [https://fastapi.tiangolo.com/advanced/custom-response/](https://fastapi.tiangolo.com/advanced/custom-response/)
...
## JSON Responses[¶](<https://fastapi.tiangolo.com/advanced/custom-response/#json-responses> "Permanent link")
...
### JSON Performance[¶](<https://fastapi.tiangolo.com/advanced/custom-response/#json-performance> "Permanent link")
...
### `orjson` or Response Model[¶](<https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model> "Permanent link")
