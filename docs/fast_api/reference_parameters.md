...
> Source: [https://fastapi.tiangolo.com/reference/parameters/](https://fastapi.tiangolo.com/reference/parameters/)
...
`examples` |  Example values for this field. Read more about it in the [FastAPI docs for Declare Request Example Data](<https://fastapi.tiangolo.com/tutorial/schema-extra-example/>) **TYPE:** `[list](<https://fastapi.tiangolo.com/python-types/#list> "List")[Any] | None` **DEFAULT:** `None`  
...
`json_schema_extra` |  Any additional JSON schema data. **TYPE:** `[dict](<https://fastapi.tiangolo.com/python-types/#dict> "Dict")[str, Any] | None` **DEFAULT:** `None`  
