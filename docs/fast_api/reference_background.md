...
> Source: [https://fastapi.tiangolo.com/reference/background/](https://fastapi.tiangolo.com/reference/background/)
...
###  `` tasks `instance-attribute` [¶](<https://fastapi.tiangolo.com/reference/background/#fastapi.BackgroundTasks.tasks> "Permanent link")
    ...
    tasks = [list](<https://fastapi.tiangolo.com/python-types/#list> "List")(tasks) if tasks else []
