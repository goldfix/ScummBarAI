# SQLite-Vector Examples | SQLite Cloud Docs

> Source: [https://docs.sqlitecloud.io/docs/sqlite-vector-examples](https://docs.sqlitecloud.io/docs/sqlite-vector-examples)

#  SQLite-Vector Examples
