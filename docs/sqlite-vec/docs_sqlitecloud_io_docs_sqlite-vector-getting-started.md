# SQLite-Vector Getting Started | SQLite Cloud Docs

> Source: [https://docs.sqlitecloud.io/docs/sqlite-vector-getting-started](https://docs.sqlitecloud.io/docs/sqlite-vector-getting-started)

#  SQLite-Vector Getting Started
...
[ Overview ](<https://docs.sqlitecloud.io/docs/sqlite-vector>)
