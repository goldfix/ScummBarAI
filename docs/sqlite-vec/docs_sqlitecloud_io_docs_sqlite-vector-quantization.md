# SQLite-Vector Quantization | SQLite Cloud Docs

> Source: [https://docs.sqlitecloud.io/docs/sqlite-vector-quantization](https://docs.sqlitecloud.io/docs/sqlite-vector-quantization)

#  SQLite-Vector Quantization
...
Where `?1` is the input vector (as a BLOB) and `?2` is the number of nearest neighbors `k`. This query compares exact and quantized results and computes the recall ratio, helping you validate the quality of quantized search.

[ API Reference ](<https://docs.sqlitecloud.io/docs/sqlite-vector-api-reference>)

[ Introduction ](<https://docs.sqlitecloud.io/docs/sqlite-sync-introduction>)
