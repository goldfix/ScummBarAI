...
Questa skill fornisce il **motore di ricerca RAG ibrido locale** per trovare istantaneamente informazioni pertinenti tra tutti gli **897 documenti (14.881 chunk)** (inclusi file `.md`, `.adoc`, `.yaml` e codici sorgente in `docs/`) senza dover scorrere manualmente indici o file statici.
